...
document.body.append(home,world,politics,magazine,technology,science,health,sports,fashion,food,travel);
//Get data from API
   ...
   try{
     // document.getElementsByClassName('container').empty();
      ...
      data.forEach((element)=>
      {
         ...
         var col2 = myElement('div','col-md-9 mt-3');
         ...
         img.setAttribute('style','height:250px;width:350px')
